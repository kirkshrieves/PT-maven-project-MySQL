...
public class ProjectsApp {
	...
	private void deleteProject() {
		...
		Integer projectsId = getIntInput("Enter the ID of the project to delete");
		
		projectService.deleteProject(projectsId);
		System.out.println("Project " + projectsId + " was deleted successfully.");
		
		if(Objects.nonNull(curProject) && curProject.getProjectId().equals(projectsId)) {
			curProject = null;
		}
